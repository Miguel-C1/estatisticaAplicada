...
with open('SAO_PAULO_TAUBATE_clean.csv', 'w') as file:
    file.writelines(cleaned_lines)

# Carregar o CSV corrigido
data = pd.read_csv('SAO_PAULO_TAUBATE_clean.csv')
